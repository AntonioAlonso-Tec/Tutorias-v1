...
public class Citas {
	...
	public List<Cita> get() {
		...
		Comparator<Tutoria> comparadorTutoria = Comparator.comparing(Tutoria::getNombre).thenComparing(Tutoria::getProfesor,comparadorProfesor);
		Comparator<Alumno> comparadorAlumno=Comparator.comparing(Alumno::getNombre);
		Comparator<Sesion> comparadorSesion=Comparator.comparing(Sesion::getHoraInicio).thenComparing(Sesion::getHoraFin)
				.thenComparing(Sesion::getFecha).thenComparing(Sesion::getMinutosDuracion).thenComparing(Sesion::getTutoria,comparadorTutoria);
		citasOrdenadas.sort(Comparator.comparing(Cita::getSesion,comparadorSesion).thenComparing(Cita::getAlumno,comparadorAlumno));
